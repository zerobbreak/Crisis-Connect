...
export default function AlertManagementSystem(props: AlertManagementProps) 
{
  const { embedded = true } = props;
  // Navigation state
...
<div>
  ...
  // Embedded compact panel (Channel Configuration)
  if (embedded) {
    return (
      <div className="mt-6">
        <h3 className="text-lg font-semibold text-gray-700 mb-3">Channel Configuration</h3>
        <div className="space-y-3">
          {CHANNELS.map((channel) => (
            <div key={channel.id} className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center space-x-3">
